            ...
            <Container fluid className='background' style={{ backgroundImage: `url(${background})`, backgroundRepeat: 'no-repeat', backgroundSize: "cover" }}>
                ...
                <Row className='overflow-hidden g-0  d-flex justify-content-around'>
                    <Col className=' my-5 ' lg={6} md={9} sm={12}>
                        <img style={{ width: '100%' }} src={selectedCourse.image} alt="" />
                        <div className='d-flex justify-content-between'>
                            <Button variant='outline-info' className='text-light  mt-3 px-3 py-2 fs-5'>Download the brochure   <MdOutlineFileDownload /> </Button>
                            <Button variant='outline-warning' className='text-light  mt-3 px-3 py-2 fs-5'>Certificate guarantee  <TiTickOutline /> </Button>
                ...
                <Row>
                    <Col md={12}>
                        ...
                        <p className='mx-5 text-light mt-3 ' style={{ textAlign: 'justify' }}>{selectedCourse.courseInfo}</p>

                    </Col>
                    <Col md={12}>
                        <h4 className='text-light mx-5'>Course Time</h4>
                        <p className='mx-5 text-light mt-3 ' style={{ textAlign: 'justify' }}>{selectedCourse.time}</p>
                    ...
                    <Col lg={8} md={12} sm={12}   >
                        <h4 className='text-light mx-5 mt-4' >Who can the attend to this course?</h4>
